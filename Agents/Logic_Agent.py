...
class KnowledgeBase:
    ...
    def update_facts(self, my_pkm_type, opp_pkm_type, move_types, move_targets, my_hp, my_max_hp, my_hp_party, my_type_party, weather):
        """
    ...
    def rule_notsupereffective_switch(self, facts):
        """
